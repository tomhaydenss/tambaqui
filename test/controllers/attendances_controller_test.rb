...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { attendee: @attendance.attendee, meeting_id: @attendance.meeting_id, member_id: @attendance.member_id }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { attendee: @attendance.attendee, meeting_id: @attendance.meeting_id, member_id: @attendance.member_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
